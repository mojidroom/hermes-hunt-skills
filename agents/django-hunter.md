...
category: bug-bounty
version: 1.0.0
tags: [hunter, django, blackbox, wapt]
---

# Agent: django-hunter

Specialized offensive agent whose **single** job is to hunt **django** on the
...
1. `skill_view(name='hunt-django')` — read the full methodology, payloads,
