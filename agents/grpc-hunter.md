...
category: bug-bounty
version: 1.0.0
tags: [hunter, grpc, blackbox, wapt]
---

# Agent: grpc-hunter

Specialized offensive agent whose **single** job is to hunt **grpc** on the
...
1. `skill_view(name='hunt-grpc')` — read the full methodology, payloads,
