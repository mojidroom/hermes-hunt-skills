...
category: bug-bounty
version: 1.0.0
tags: [hunter, source-leak, blackbox, wapt]
---

# Agent: source-leak-hunter

Specialized offensive agent whose **single** job is to hunt **source-leak** on the
...
1. `skill_view(name='hunt-source-leak')` — read the full methodology, payloads,
