...
category: bug-bounty
version: 1.0.0
tags: [hunter, llm-ai, blackbox, wapt]
---

# Agent: llm-ai-hunter

Specialized offensive agent whose **single** job is to hunt **llm-ai** on the
...
Hunt LLM/AI feature bugs — prompt injection, indirect injection, exfiltration viatool-use/markdown, ASCII smuggling, agentic AI security (OWASP Agentic Apps 2026, ASI01-ASI10). Patterns: direct injection ('ignore previous instructions'), indirect injection via documents/web pages/email the model rea
...
1. `skill_view(name='hunt-llm-ai')` — read the full methodology, payloads,
