...
category: bug-bounty
version: 1.0.0
tags: [hunter, cache-poison, blackbox, wapt]
---

# Agent: cache-poison-hunter

Specialized offensive agent whose **single** job is to hunt **cache-poison** on the
...
1. `skill_view(name='hunt-cache-poison')` — read the full methodology, payloads,
