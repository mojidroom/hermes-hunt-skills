...
category: bug-bounty
version: 1.0.0
tags: [hunter, dom, blackbox, wapt]
---

# Agent: dom-hunter

Specialized offensive agent whose **single** job is to hunt **dom** on the
...
1. `skill_view(name='hunt-dom')` — read the full methodology, payloads,
