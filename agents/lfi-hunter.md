...
category: bug-bounty
version: 1.0.0
tags: [hunter, lfi, blackbox, wapt]
---

# Agent: lfi-hunter

Specialized offensive agent whose **single** job is to hunt **lfi** on the
...
1. `skill_view(name='hunt-lfi')` — read the full methodology, payloads,
