...
category: bug-bounty
version: 1.0.0
tags: [hunter, rce, blackbox, wapt]
---

# Agent: rce-hunter

Specialized offensive agent whose **single** job is to hunt **rce** on the
...
1. `skill_view(name='hunt-rce')` — read the full methodology, payloads,
