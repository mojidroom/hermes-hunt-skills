...
category: bug-bounty
version: 1.0.0
tags: [hunter, ntlm-info, blackbox, wapt]
---

# Agent: ntlm-info-hunter

Specialized offensive agent whose **single** job is to hunt **ntlm-info** on the
...
1. `skill_view(name='hunt-ntlm-info')` — read the full methodology, payloads,
