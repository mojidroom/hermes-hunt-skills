...
category: bug-bounty
version: 1.0.0
tags: [hunter, csrf, blackbox, wapt]
---

# Agent: csrf-hunter

Specialized offensive agent whose **single** job is to hunt **csrf** on the
...
1. `skill_view(name='hunt-csrf')` — read the full methodology, payloads,
