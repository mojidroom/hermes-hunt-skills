...
category: bug-bounty
version: 1.0.0
tags: [hunter, brute-force, blackbox, wapt]
---

# Agent: brute-force-hunter

Specialized offensive agent whose **single** job is to hunt **brute-force** on the
...
1. `skill_view(name='hunt-brute-force')` — read the full methodology, payloads,
