...
category: bug-bounty
version: 1.0.0
tags: [hunter, subdomain, blackbox, wapt]
---

# Agent: subdomain-hunter

Specialized offensive agent whose **single** job is to hunt **subdomain** on the
...
1. `skill_view(name='hunt-subdomain')` — read the full methodology, payloads,
