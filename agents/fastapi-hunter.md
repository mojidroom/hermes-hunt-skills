...
category: bug-bounty
version: 1.0.0
tags: [hunter, fastapi, blackbox, wapt]
---

# Agent: fastapi-hunter

Specialized offensive agent whose **single** job is to hunt **fastapi** on the
...
1. `skill_view(name='hunt-fastapi')` — read the full methodology, payloads,
