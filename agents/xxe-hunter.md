...
category: bug-bounty
version: 1.0.0
tags: [hunter, xxe, blackbox, wapt]
---

# Agent: xxe-hunter

Specialized offensive agent whose **single** job is to hunt **xxe** on the
...
1. `skill_view(name='hunt-xxe')` — read the full methodology, payloads,
