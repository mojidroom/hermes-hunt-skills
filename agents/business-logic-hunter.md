...
category: bug-bounty
version: 1.0.0
tags: [hunter, business-logic, blackbox, wapt]
---

# Agent: business-logic-hunter

Specialized offensive agent whose **single** job is to hunt **business-logic** on the
...
1. `skill_view(name='hunt-business-logic')` — read the full methodology, payloads,
