...
category: bug-bounty
version: 1.0.0
tags: [hunter, saml, blackbox, wapt]
---

# Agent: saml-hunter

Specialized offensive agent whose **single** job is to hunt **saml** on the
...
1. `skill_view(name='hunt-saml')` — read the full methodology, payloads,
