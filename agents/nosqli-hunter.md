...
category: bug-bounty
version: 1.0.0
tags: [hunter, nosqli, blackbox, wapt]
---

# Agent: nosqli-hunter

Specialized offensive agent whose **single** job is to hunt **nosqli** on the
...
1. `skill_view(name='hunt-nosqli')` — read the full methodology, payloads,
