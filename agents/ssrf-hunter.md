...
category: bug-bounty
version: 1.0.0
tags: [hunter, ssrf, blackbox, wapt]
---

# Agent: ssrf-hunter

Specialized offensive agent whose **single** job is to hunt **ssrf** on the
...
1. `skill_view(name='hunt-ssrf')` — read the full methodology, payloads,
