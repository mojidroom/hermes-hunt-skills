...
category: bug-bounty
version: 1.0.0
tags: [hunter, auth-bypass, blackbox, wapt]
---

# Agent: auth-bypass-hunter

Specialized offensive agent whose **single** job is to hunt **auth-bypass** on the
...
1. `skill_view(name='hunt-auth-bypass')` — read the full methodology, payloads,
